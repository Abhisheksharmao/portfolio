    ...
    return (
        <>
            <div className='home-mt1' >
                <div className="mt1">
                    <h1 style={{ color: "#f1faee" }}>I am Abishek Sharma</h1>
                    <h1 style={{ marginLeft: "100px", color: "#f1faee" }}>UX designer</h1>
                    <br />
                    <h2 style={{color:"white"}}>Abhisheksh0012@gmail.com</h2>
                </div>
                <div className="mt2">
            ...
            {/* project */}
            <div className="pl" data-aos="fade-up" data-aos-delay="50"  ><img src="./img/prj.jpg" alt="" height="600px" width="100%" /></div>

            <div className="prj" data-aos="fade-up" data-aos-delay="50" >
                <div className="Library">
                    <h2 style={{ color: "white" }} >Find my Library</h2>
                    ...
                    >
                        <button style={{ color: "white" }}><h2>Case study</h2> </button>
                    </a>

                </div>
                <div className="Shoes_store" >
                    <h2 style={{ color: "#f1faee" }}>Shoes Store</h2>
                ...
                <div className="gardner" >
                    <h2 style={{ color: "white" }}>Gardner</h2>
